...
urlpatterns = [
    ...
    path('plasmid/align/sanger/<uuid:plasmid_id>/run/<uuid:run_id>/read/<uuid:read_id>/file/<uuid:file_id>/primer', login_required(views.sanger_read_file_primer_update, redirect_field_name='next'), name='sanger_read_file_primer_update'),
    ...
    path('services/sanger/batch-upload/', login_required(views.sanger_batch_upload, redirect_field_name='next'), name='sanger_batch_upload'),
